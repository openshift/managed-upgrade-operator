...
// Source: github.com/openshift/managed-upgrade-operator/pkg/upgrade_config_manager (interfaces: UpgradeConfigManagerBuilder)
...
import (
	...
	upgrade_config_manager "github.com/openshift/managed-upgrade-operator/pkg/upgrade_config_manager"
...
func (m *MockUpgradeConfigManagerBuilder) NewManager(arg0 client.Client) (upgrade_config_manager.UpgradeConfigManager, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewManager", arg0)
	ret0, _ := ret[0].(upgrade_config_manager.UpgradeConfigManager)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
