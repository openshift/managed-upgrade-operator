...
//
//	mockgen -destination=mocks/nodeDrainStrategy.go -package=mocks github.com/openshift/managed-upgrade-operator/pkg/drain NodeDrainStrategy
//
...
func (mr *MockNodeDrainStrategyMockRecorder) Execute(arg0, arg1 any) *gomock.Call {
...
func (mr *MockNodeDrainStrategyMockRecorder) HasFailed(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
