...
const (
	...
	UPGRADE_PREHEALTHCHECK_DELAY_DESC = "Cluster upgrade to version %s is experiencing a delay as health alerts are firing in the cluster which could impact the upgrade's operation. The upgrade will continue to retry. This is an informational notification and no action is required by you. Please refer to the article for further details https://access.redhat.com/solutions/7081505"
	...
	UPGRADE_HEALTHCHECK_DELAY_DESC = "Cluster upgrade to version %s may experience a delay as following healthcheck(s): %s are failing for the cluster which could impact the upgrade's operation. Please refer to the article for further details https://access.redhat.com/solutions/7081505"
	// UPGRADE_HEALTHCHECK_DELAY_DESC describes the upgrade pre health check delay
	UPGRADE_PREHEALTHCHECK_WARNING_DESC = "Cluster upgrade to version %s has been scheduled for more than 2 hours, cluster pre-upgrade health check has identified the following points which may impact the upgrade process: %s. Please take actions to review and fix the issues before the upgrade begins to have seamless upgrade experience https://access.redhat.com/solutions/7081505"
