...
require (
	...
	github.com/openshift/cluster-version-operator v1.0.1-0.20230322131514-c659e6ccaca7 // indirect
	github.com/openshift/operator-custom-metrics v0.5.1 // indirect
