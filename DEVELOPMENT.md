...
Quick reference for developing the Managed Upgrade.
...
go test ./controllers/upgradeconfig/...  # Test specific package
...
```bash
# Run specific test
ginkgo -focus="NetworkPolicy" ./controllers/upgradeconfig/

# Run tests for one package
go test -v ./controllers/upgradeconfig/
...
- **Controllers**: `controllers/{upgradeconfig,nodekeeper}/` - Reconciliation logic
- **Business Logic**: `controllers/upgradeconfig/` - Resource management
